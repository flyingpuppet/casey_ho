...
// (DO NOT EDIT: machine generated header) 'WinSkinData.pas' rev: 6.00
...
static const short NM_COOLSB_CUSTOMDRAW = 0xfffff501;
#define c_version "4.22.08.28"
...
extern PACKAGE WideString __fastcall _WStr(wchar_t * lpString, int cchCount);
...
extern PACKAGE void __fastcall CopyBMP(Graphics::TBitmap* sbmp, Graphics::TBitmap* dbmp);
