...
void __fastcall TMainForm::FormCreate(TObject *Sender)
{
    ...
    RegisterClass(__classid(TForm_DPMeter));
...
void __fastcall TMainForm::CreateBIN1Click(TObject *Sender)
{
...
void __fastcall TMainForm::ScanRGB1Click(TObject *Sender)
{
    Form_ScanRGB = new TForm_ScanRGB(this);
    Form_ScanRGB->ShowModal();
}
//---------------------------------------------------------------------------
