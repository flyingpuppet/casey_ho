...
void __fastcall TForm_DataPath::SetInputType(InputType in)
{
    ...
    switch(in)
    {
        ...
        case VD:
            ...
            GetDevice()->AllWriteDWord(0xE0000000, 0x03800100);
            GetDevice()->AllWriteDWord(0xE0000004, 0x08800600);
            GetDevice()->AllWriteDWord(0xE000000C, 0x12801000);
            GetDevice()->AllWriteDWord(0xE0000010, 0x17801500);
            GetDevice()->AllWriteDWord(0xE0000018, 0x21801F00);
            GetDevice()->AllWriteDWord(0xE000001C, 0x26802400);
