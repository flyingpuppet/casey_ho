...
#ifndef UFrame_BWMeasureH
#define UFrame_BWMeasureH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
class TFrame_BWMeasure : public TMEMCFrame
{
...
public:		// User declarations
    __fastcall TFrame_BWMeasure(TComponent* Owner);
    virtual void __fastcall ReadMeasure(int count, int index, int readNum =3);
};
//---------------------------------------------------------------------------
extern PACKAGE TFrame_BWMeasure *Frame_BWMeasure;
//---------------------------------------------------------------------------
#endif
